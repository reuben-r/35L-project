  ...
  return (
    <div>
      ...
      <div>
        ...
        {"     "}
        <button onClick={() => setType1(document.getElementById("type").value)}>
          Set
        </button>
        <br />
        <p />
  ...
  function calculateSched(i) {
    ...
    if (matchM1) {
      if (matchM1[3] == "AM" || matchM1[1] == 12) {
        // <=========================================== Checks if time is "AM" or "PM" and sets value accordingly. 2PM = 14 or 10AM = 10
    ...
    if (matchM2) {
      if (matchM2[3] == "AM" || matchM2[1] == 12) {
        setmDep(parseInt(matchM2[1]) + 1); // <========================== Adds an extra hour to the first value of time to round up. i.e. 9:50AM = 9 + 1 = 10AM || 8:50PM = 20 + 1 = 21 = 9PM
      } else {
  ...
  return (
    <div>
      ...
      <div>
        ...
        <button
          onClick={() => setAddress1(document.getElementById("address1").value)}
        >
          Set
        </button>
        <br />
